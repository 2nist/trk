#!/bin/bash
# run_sketch_tests.sh - Run just the Sketch Mode tests

cd "$(dirname "$0")"

echo "========================================"
echo "    TESTING SKETCH MODE WITH VIRTUAL REAPER"
echo "========================================"
echo ""
...
local env = Package.setup({verbose = false, simulate_ui = true, skip_heavy_rendering = true})
