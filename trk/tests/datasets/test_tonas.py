...
def test_load_melody():
    ...
    assert np.array_equal(
        f0_data_corrected.frequencies,
        np.array([0.000, 379.299, 379.299, 379.299]),
    )
    assert np.array_equal(
        f0_data_corrected.voicing, np.array([0.0, 1.0, 1.0, 1.0])
    )
    assert np.array_equal(
    ...
    assert np.array_equal(
        ...
        np.array([0.000, 0.000, 143.918, 143.918]),
    )
    assert np.array_equal(
        f0_data_automatic.voicing, np.array([0.0, 0.0, 1.0, 1.0])
    )
    assert np.array_equal(
...
def test_load_notes():
    ...
    assert np.array_equal(
        ...
        np.array([0.018007, 0.010794, 0.00698, 0.03265]),
    )
