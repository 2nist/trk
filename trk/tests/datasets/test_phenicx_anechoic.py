...
def test_load_score():
    ...
    assert np.array_equal(
        note_data.intervals,
        np.array(
            [[4.284082, 5.271338], [4.284082, 5.271338], [4.284082, 5.271338]]
        ),
    )
    assert np.allclose(
        note_data.pitches, np.array([220.0, 329.62755691, 554.36526195])
    )
...
def test_get_notes_target():
    ...
    assert np.allclose(
        note_data.pitches,
        np.array(
            [220.0, 329.62755691, 554.36526195, 220.0, 329.62755691, 220.0]
        ),
    )
...
def test_get_notes_for_section():
    ...
    note_data = mtrack.get_notes_for_section(
        section="strings", notes_property="notes"
    )
