...
def test_track():
    ...
    assert default_track._track_paths == {
        "audio": [
            "Participant 1/02/Sax.wav",
            "c62cd9d2ec8085461cb2ffc9deeda176",
        ],
        "annotation": [
            "Participant 1/02/annotations.json",
        ...
        "midi": [
            "Participant 1/02/Sax.mid",
            "007beb3b84dfaafbc8767148bc00c0ff",
        ],
        "musicXML": [
            "Participant 1/02/Sax.musicxml",
        ...
        "pdf": [
            "Participant 1/02/Sax.pdf",
            "69b20b5b95b8807137cc86e7c72cc861",
        ],
    }

    run_track_tests(
        default_track, expected_attributes, expected_property_types
    )
