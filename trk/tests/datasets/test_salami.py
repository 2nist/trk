...
def test_track():
    ...
    assert (
        type(track.sections_annotator_1_uppercase) is annotations.SectionData
    )
    assert (
        type(track.sections_annotator_1_lowercase) is annotations.SectionData
    )
    ...
    assert (
        type(track.sections_annotator_2_uppercase) is annotations.SectionData
    )
    assert (
        type(track.sections_annotator_2_lowercase) is annotations.SectionData
    )
