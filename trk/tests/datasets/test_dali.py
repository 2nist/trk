...
def test_load_notes():
    ...
    assert np.array_equal(
        note_data.intervals[:, 0], np.array([24.125, 24.273, 24.420])
    )
    assert np.array_equal(
        note_data.intervals[:, 1], np.array([24.273, 24.420, 24.568])
    )
    assert np.array_equal(
        note_data.pitches, np.array([1108.731, 1108.731, 1108.731])
    )
...
def test_load_words():
    ...
    assert np.array_equal(
        word_data.intervals[:, 0], np.array([24.125, 24.273, 24.42])
    )
    assert np.array_equal(
        word_data.intervals[:, 1], np.array([24.273, 24.42, 24.568])
    )
...
def test_load_lines():
    ...
    assert np.array_equal(
        line_data.intervals[:, 0], np.array([24.125, 24.42])
    )
    assert np.array_equal(
        line_data.intervals[:, 1], np.array([24.42, 24.568])
    )
...
def test_load_paragraphs():
    ...
    assert np.array_equal(
        par_data.intervals[:, 0], np.array([24.125, 24.420])
    )
    assert np.array_equal(
        par_data.intervals[:, 0], np.array([24.125, 24.420])
    )
    assert np.array_equal(
        par_data.intervals[:, 1], np.array([24.420, 24.568])
    )
