...
def test_load_f0():
    ...
    assert np.array_equal(
        f0.times,
        np.array(
            [0.400544218, 0.406349206, 0.412154195, 0.417959184, 0.423764172]
        ),
    )
    assert np.array_equal(
        f0.frequencies,
        np.array([129.387, 126.634, 125.182, 124.943, 124.491]),
    )
...
def test_load_beat():
    ...
    assert np.array_equal(
        beat.times,
        np.array(
            [0.174149660, 0.949115646, 1.724081633, 2.525170068, 3.308843537]
        ),
    )
