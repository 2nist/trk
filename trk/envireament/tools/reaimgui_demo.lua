...
-- Apply a custom style to the ImGui context
function ApplyCustomStyle()
  ImGui.PushStyleColor(ImGui.Col_WindowBg, 0.1, 0.1, 0.1, 1.0) -- Dark background
  ImGui.PushStyleColor(ImGui.Col_Text, 0.9, 0.9, 0.9, 1.0) -- Light text
  ImGui.PushStyleColor(ImGui.Col_Button, 0.2, 0.5, 0.8, 1.0) -- Blue buttons
  ImGui.PushStyleColor(ImGui.Col_ButtonHovered, 0.3, 0.6, 0.9, 1.0) -- Lighter blue on hover
  ImGui.PushStyleColor(ImGui.Col_ButtonActive, 0.1, 0.4, 0.7, 1.0) -- Darker blue on click
  ImGui.PushStyleColor(ImGui.Col_FrameBg, 0.2, 0.2, 0.2, 1.0) -- Darker frame background
  ImGui.PushStyleColor(ImGui.Col_FrameBgHovered, 0.3, 0.3, 0.3, 1.0) -- Lighter frame background on hover
  ImGui.PushStyleColor(ImGui.Col_FrameBgActive, 0.4, 0.4, 0.4, 1.0) -- Active frame background
  ImGui.PushStyleVar(ImGui.StyleVar_FrameRounding, 5.0) -- Rounded corners for frames
  ImGui.PushStyleVar(ImGui.StyleVar_WindowRounding, 5.0) -- Rounded corners for windows
end

-- Restore the default style
function RestoreDefaultStyle()
  ImGui.PopStyleColor(8) -- Restore the last 8 style colors
  ImGui.PopStyleVar(2) -- Restore the last 2 style variables
end
...
function Main()
  ...
  if ImGui.Begin(ctx, "Custom Styled Window") then
    ImGui.Text("This window uses a custom style!")
...
-- Replace the existing loop with the styled version
function Run()
